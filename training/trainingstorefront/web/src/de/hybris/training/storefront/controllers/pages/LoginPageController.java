...
import de.hybris.training.facades.forms.EcentaConsentForm;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer, final EcentaRegisterForm form,
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(new EcentaRegisterForm()); // here need newly created
	...
	protected String processRegisterUserRequest(final String referer, final EcentaRegisterForm form, final BindingResult bindingResult,
												...
												final RedirectAttributes redirectModel) throws CMSItemNotFoundException // NOSONAR
	{
		...
		try
		{
			final EcentaConsentForm ecentaConsentForm = form.getEcentaConsentForm();
			if (ecentaConsentForm != null && ecentaConsentForm.getConsentGiven())
			{
				getConsentFacade().giveConsent(ecentaConsentForm.getConsentTemplateId(), ecentaConsentForm.getConsentTemplateVersion());
			}
		}
